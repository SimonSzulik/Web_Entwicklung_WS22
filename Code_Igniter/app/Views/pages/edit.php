    ...
    <div class="row">
        ...
        <form class="form-group">
            ...
            <table class="table table-hover">
                ...
                <td><?php if (isset($mitglieder['inProjekt']) && $mitglieder['inProjekt'] == 'Y') {
                        $mitglieder['state'] = 'checked';
                    } else {
                        $mitglieder['state'] = 'unchecked';
                    } ?><?= isset($mitglieder['inProjekt']) ? '<input class="form-check-input" type="checkbox"' . $mitglieder['state'] . '>' : '' ?></td>
                <td class="text-right">
